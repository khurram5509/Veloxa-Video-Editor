# Build Veloxa Video Editor V14.0.1 into a single Windows EXE.
...
pyinstaller --noconfirm --onefile --windowed `
    --name "Veloxa-Video-Editor-V14.0.1" `
    --paths . `
...
Write-Host ""
Write-Host "Build complete: dist\Veloxa-Video-Editor-V14.0.1.exe" -ForegroundColor Green
