# Build Veloxa Video Editor V14.3.4 into a single Windows EXE.
...
pyinstaller --noconfirm --onefile --windowed `
    --name "Veloxa-Video-Editor-V14.3.4" `
    --paths . `
...
Write-Host ""
Write-Host "Build complete: dist\Veloxa-Video-Editor-V14.3.4.exe" -ForegroundColor Green
