# Build Veloxa Video Editor V14.9.1 as a Windows --onedir bundle.
# Run from project root:  .\build.ps1
#
# V14.9.1: switched from --onefile to --onedir because --onefile's
...
# --onedir: produces dist\Veloxa-Video-Editor-V14.9.1\
#   ├── Veloxa-Video-Editor-V14.9.1.exe   (small launcher)
...
pyinstaller --noconfirm --onedir --windowed `
    --name "Veloxa-Video-Editor-V14.9.1" `
    --paths . `
...
Write-Host ""
Write-Host "Build complete: dist\Veloxa-Video-Editor-V14.9.1\" -ForegroundColor Green
