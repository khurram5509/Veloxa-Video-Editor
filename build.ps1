# Build Veloxa Video Editor V14.3.0 into a single Windows EXE.
...
pyinstaller --noconfirm --onefile --windowed `
    --name "Veloxa-Video-Editor-V14.3.0" `
    --paths . `
...
Write-Host ""
Write-Host "Build complete: dist\Veloxa-Video-Editor-V14.3.0.exe" -ForegroundColor Green
