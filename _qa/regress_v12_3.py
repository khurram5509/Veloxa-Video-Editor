...
check("APP_VERSION = '14.11.4'", _APP_VERSION == "14.11.4",
...
check("installer.iss AppVersion = 14.11.4", '"14.11.4"' in iss_src)
check("installer.iss EXE name = V14.11.4.exe",
      "Veloxa-Video-Editor-V14.11.4.exe" in iss_src)
...
check("build.ps1 builds V14.11.4 EXE",
      "Veloxa-Video-Editor-V14.11.4" in ps1_src)
