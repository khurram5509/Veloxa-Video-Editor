...
check("APP_VERSION = '14.11.3'", _APP_VERSION == "14.11.3",
...
check("is_newer('14.11.0', '13.0')", _newer("14.11.0", "13.0"))
check("is_newer('14.11.0', '14.9.1') -- two-digit minor beats 9",
      _newer("14.11.0", "14.9.1"))
check("is_newer('14.11.0', '14.10.0')", _newer("14.11.0", "14.10.0"))
...
check("installer.iss AppVersion = 14.11.3", '"14.11.3"' in iss_src)
check("installer.iss EXE name = V14.11.3.exe",
      "Veloxa-Video-Editor-V14.11.3.exe" in iss_src)
...
check("build.ps1 builds V14.11.3 EXE",
      "Veloxa-Video-Editor-V14.11.3" in ps1_src)
