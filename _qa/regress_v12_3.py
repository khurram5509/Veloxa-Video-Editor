...
check("APP_VERSION = '14.3.7'", _APP_VERSION == "14.3.7",
...
check("is_newer('14.3.7', '13.0')", _newer("14.3.7", "13.0"))
...
check("installer.iss AppVersion = 14.3.7", '"14.3.7"' in iss_src)
check("installer.iss EXE name = V14.3.7.exe",
      "Veloxa-Video-Editor-V14.3.7.exe" in iss_src)
...
check("build.ps1 builds V14.3.7 EXE",
      "Veloxa-Video-Editor-V14.3.7" in ps1_src)

# V14.3.7 crash-fix: stale C++-object guard in _start_update_check.
...
# ===========================================================================
# 13. V14.3.7: System / Light / Dark theme switcher
# ===========================================================================
section("V14.3.7: theme switcher")
...
# V14.3.7: light theme redesign — depth + hierarchy.
...
# V14.3.7: actually run each template's filter graph through FFmpeg
...
# ===========================================================================
# 15. V14.3.7: updater download runs on a QThread (no more GUI freeze)
# ===========================================================================
section("V14.3.7: updater download worker")
...
check("download_installer chunk size = 64 KB (V14.3.7 perf fix)",
...
# ===========================================================================
# 16. V14.3.7: preview overlay clears + installer no longer side-by-side
# ===========================================================================
section("V14.3.7: preview clear + installer overwrite")
...
# ===========================================================================
# 17. V14.3.7: Single instance + HiDPI + responsive hardening
# ===========================================================================
section("V14.3.7: single-instance, HiDPI, min size")
...
# ===========================================================================
# 18. V14.3.7: single-instance ACK handshake + dynamic version log
# ===========================================================================
section("V14.3.7: single-instance ACK + dynamic persistence version")
...
# ===========================================================================
# 19. V14.3.7: macOS source-level support + GitHub Actions
# ===========================================================================
section("V14.3.7: cross-platform foundation")
...
mac_assets = [
    {"name": "Veloxa-Video-Editor-V14.3.7-Setup.exe"},
    {"name": "Veloxa-Video-Editor-V14.3.7-macOS.dmg"},
]
...
# ===========================================================================
# V14.3.7 — Parallel CPU encoder slot + add-files-while-batch-runs
# ===========================================================================
section("V14.3.7 — CPU/GPU parallel slot + safety + queue-add")
...
# ===========================================================================
# V14.3.7 — first-video-stuck-at-0% progress fix
# ===========================================================================
section("V14.3.7 — progress emission fix")
...
# ===========================================================================
# V14.3.7 — audio-template preview pane fix
# ===========================================================================
section("V14.3.7 — audio-template preview pane")
...
# ===========================================================================
# V14.3.7 — platform-asset routing must never mix .exe and .dmg
# ===========================================================================
section("V14.3.7 — Win → .exe only / Mac → .dmg only (no mixing)")
...
# ===========================================================================
# V14.3.7 — auto-assign audio visuals at add-to-queue time
# ===========================================================================
section("V14.3.7 — auto-assign audio visuals on add")
...
# ===========================================================================
# V14.3.7 — light-theme queue-row text was invisible (white-on-white)
# ===========================================================================
section("V14.3.7 — light theme: queue-row labels must be readable")
...
# ===========================================================================
# V14.3.7 — build mode: --onedir (was --onefile, caused python314.dll
# LoadLibrary failures after Windows in-app updates)
# ===========================================================================
section("V14.3.7 — Windows build uses --onedir (no _MEI extract race)")
