; Inno Setup script for Veloxa Video Editor V14.5.0
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.5.0-Setup.exe.
;
; V14.5.0 fix: the installed EXE is now ALWAYS named
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.5.0.exe"
...
[Files]
; V14.5.0: PyInstaller now produces a --onedir bundle at
; dist\Veloxa-Video-Editor-V14.5.0\ containing the launcher EXE plus a
...
[InstallDelete]
; V14.5.0: clean up legacy versioned filenames + shortcuts left behind
; by V11 .. V14.5.0 installs (which were single-EXE --onefile builds).
...
; EXEs in {app}. Also wipe any pre-existing _internal\ from a V14.5.0+
...
[UninstallDelete]
; V14.5.0: --onedir lays down the EXE + _internal\ subtree under {app}.
