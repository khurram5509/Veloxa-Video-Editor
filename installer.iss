; Inno Setup script for Veloxa Video Editor V14.3.4
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.3.4-Setup.exe.
;
; V14.3.4 fix: the installed EXE is now ALWAYS named
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.3.4.exe"
...
; renames it to the unversioned filename at install time so V14.3.4
...
[InstallDelete]
; V14.3.4: clean up legacy versioned filenames + shortcuts left behind
