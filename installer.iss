; Inno Setup script for Veloxa Video Editor V14.11.4
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.11.4-Setup.exe.
;
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.11.4.exe"
