; Inno Setup script for Veloxa Video Editor V14.1.1
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.1.1-Setup.exe.
;
; V14.1.1 fix: the installed EXE is now ALWAYS named
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.1.1.exe"
...
; renames it to the unversioned filename at install time so V14.1.1
...
[InstallDelete]
; V14.1.1: clean up legacy versioned filenames + shortcuts left behind
