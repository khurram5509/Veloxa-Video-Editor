; Inno Setup script for Veloxa Video Editor V14.11.0
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.11.0-Setup.exe.
;
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.11.0.exe"
