; Inno Setup script for Veloxa Video Editor V14.9.0
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.9.0-Setup.exe.
;
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.9.0.exe"
