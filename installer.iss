; Inno Setup script for Veloxa Video Editor V14.11.3
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.11.3-Setup.exe.
;
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.11.3.exe"
...
[Files]
; V14.8.1: PyInstaller now produces a --onedir bundle at
; dist\Veloxa-Video-Editor-V14.8.1\ containing the launcher EXE plus a
...
[InstallDelete]
; V14.8.1: clean up legacy versioned filenames + shortcuts left behind
; by V11 .. V14.8.1 installs (which were single-EXE --onefile builds).
...
; EXEs in {app}. Also wipe any pre-existing _internal\ from a V14.8.1+
...
[UninstallDelete]
; V14.8.1: --onedir lays down the EXE + _internal\ subtree under {app}.
