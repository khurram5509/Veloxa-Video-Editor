; Inno Setup script for Veloxa Video Editor V14.4.1
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.4.1-Setup.exe.
;
; V14.4.1 fix: the installed EXE is now ALWAYS named
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.4.1.exe"
...
[Files]
; V14.4.1: PyInstaller now produces a --onedir bundle at
; dist\Veloxa-Video-Editor-V14.4.1\ containing the launcher EXE plus a
...
[InstallDelete]
; V14.4.1: clean up legacy versioned filenames + shortcuts left behind
; by V11 .. V14.4.1 installs (which were single-EXE --onefile builds).
...
; EXEs in {app}. Also wipe any pre-existing _internal\ from a V14.4.1+
...
[UninstallDelete]
; V14.4.1: --onedir lays down the EXE + _internal\ subtree under {app}.
