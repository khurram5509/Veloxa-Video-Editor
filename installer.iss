; Inno Setup script for Veloxa Video Editor V14.8.1
...
;
; The output lands in .\installer\Veloxa-Video-Editor-V14.8.1-Setup.exe.
;
...
; DestName= in [Files].
#define AppBuildExe         "Veloxa-Video-Editor-V14.8.1.exe"
